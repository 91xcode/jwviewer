...
import jwviewer.dao.ISeriesDao;
...
public class SeriesDao extends BaseDaoImpl<Series, String> implements ISeriesDao {

	protected SeriesDao(ConnectionSource connectionSource, Class<Series> dataClass) throws SQLException {
		super(connectionSource, dataClass);
	}

	public SeriesDao(ConnectionSource connectionSource) throws SQLException {
		super(connectionSource, Series.class);
	}
...
//				{"code": 0,"msg": "Success","data": {"total": 21180,"data": [{metadata}],metaInfo:{star}}}
				...
				if (jsonNode.get("code").asInt() == 0) {
					...
					for (Metadata metadata : list) {
						System.out.println("starId:"+starId+",metadataId:"+metadata.getMetadataId()+","+metadata.getjAVID());
