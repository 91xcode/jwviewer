...
import jwviewer.dao.ITagMapDao;
import jwviewer.dto.Tag;
import jwviewer.dto.TagMap;
import jwviewer.http.HTTP;
import jwviewer.json.Json;
import jwviewer.ormlite.SQLite;
import jwviewer.website.Api;

public class TagMapDao extends BaseDaoImpl<TagMap, String> implements ITagMapDao {

	protected TagMapDao(ConnectionSource connectionSource, Class<TagMap> dataClass) throws SQLException {
		super(connectionSource, dataClass);
	}

	public TagMapDao(ConnectionSource connectionSource) throws SQLException {
		super(connectionSource, TagMap.class);
	}
