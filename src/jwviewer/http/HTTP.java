...
//						System.out.println();
	...
	public static List<Metadata> wGetMetadataByStarId(int starId) {
		...
		for (int i = 1; i <= pageNo; i++) {
			List<Metadata> list = wgetMetadataByStarId(starId, i);
			arrayList.addAll(list);
		}
		return arrayList;
	}

	private static int wgetMetadataCountByStarId(int starId) {
		int count = 0;
...
//			{"code": 0,"msg": "Success","data": {"total": 21180,"data": [{metadata}],metaInfo:{star}}}
	...
	private static List<Metadata> wgetMetadataByStarId(int starId, int pageNo) {
		Dao<Metadata, String> mdao = SQLite.getDao(Metadata.class);
...
//						System.out.println(
//								"starId:" + starId + ",metadataId:" + metadata.getId() + "," + metadata.getjAVID());
